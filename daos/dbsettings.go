...
func ConnStringConfig() (string, error) {
	return "postgres://ppbwkxkrjzbksv:ed30e87a9d372447e4910d34b84c653ac6f67209f6a4034390f791a810f6c8ca@ec2-52-70-186-184.compute-1.amazonaws.com:5432/dci84nq5jb8beh", nil
	/*
		m := map[string]string{
			FSTR_DB_LOGIN: "",
			FSTR_DB_PASS:  "",
